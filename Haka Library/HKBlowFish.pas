...
- Modifications by Harry Kakoulidis
...
type
  TBoxes = record
             PBox:  Array[1..34]   of Cardinal;
             SBox1: Array[1..$100] of Cardinal;
             SBox2: Array[1..$100] of Cardinal;
             SBox3: Array[1..$100] of Cardinal;
             SBox4: Array[1..$100] of Cardinal;
           end;
 ...
 function EncryptStr(const Str,key : string) : string;
 function DecryptStr(const Str,key : string) : string;
...
Const Pad : Array[1..8] of char = #0#0#0#0#0#0#0#0;
var num : byte;
begin
